---
name: detective-v2b
description: Search the haystack/ folder for a query by delegating all work to a sub-agent, then relay the sub-agent's file list verbatim. Use when asked to run a detective-v2b style search of the haystack folder.
---
