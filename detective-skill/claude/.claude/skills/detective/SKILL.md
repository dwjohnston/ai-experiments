---
name: detective
description: Search the haystack/ folder for information relevant to a query and summarize findings directly, without delegating to a subagent. Use when the user invokes /detective or asks to search the haystack folder for a topic.
---
